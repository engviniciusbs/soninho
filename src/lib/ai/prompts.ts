...
export const SUGGESTION_PROMPT = `Com base nos dados de sono fornecidos, analise o padrão do dia de hoje e sugira o melhor horário para a próxima soneca.
...
Responda EXCLUSIVAMENTE em JSON válido com esta estrutura:
{
  ...
  "windowStart": "HH:MM",
  "windowEnd": "HH:MM",
  "reasoning": "explicação breve em 2-3 frases",
  "confidence": "high" | "medium" | "low"
}

Se não houver dados suficientes para sugerir, use confidence "low" e explique no reasoning.`;
